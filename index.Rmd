...
Este sitio es una guia para el curso de Ciencia de Datos con R, BIOL4026 en la Universidad de Puerto Rico en Humacao. El objetivo de este sitio es presentar una organización simple y básica para la manipulación de datos para análisis y visualización.

El presente curso tiene como objetivo es integrar componente de visualización de datos, manipulación de datos y una introducción a estadística intermedia con R.
...
- El YAML header para modificar la aprencia del documento Estadística intermedia
...
***
### Puntuación: 
Este curso sera evaluado con los siguiente item:
...
***
### Faltar en someter trabajos a tiempo:
*Los trabajos cortos y pruebas cortas NO se reponen*.  Si falta a la clase es su responsabilidad hablar con los otros estudiantes para saber lo que se discutió en la clase. Si no se somete a tiempo el trabajo es automatico un cero. 
